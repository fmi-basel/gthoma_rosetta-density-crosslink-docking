...
if __name__ == '__main__':
    ...
    parser.add_argument('--chains1', type=str, required=True, help='Target chains which are kept fixed during docking, e.g. ABCDE')
    parser.add_argument('--chains2', type=str, required=True, help='Chains to be docked against fixed chains, e.g. FG')
    ...
    parser.add_argument('--xl_threshold_distance', type=float, default=30.0, help='Maximum valid crosslink distance in Angstrom')
    ...
    parser.add_argument('--dist_measure', default='dist', type=str, choices=['euk_dist', 'sas_dist'], help='One of [euk_dist, sas_dist]. Uses either euclidean distance or SAS distance for crosslink scoring (see Xwalk documentation)')
